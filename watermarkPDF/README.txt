...
3) right-click a pdf, select "Actions" and select "Watermark PDF"
...
6) now select the PDF again and just fill the prompts accordingly

7) you'll the be prompted to save the new watermarked PDF
